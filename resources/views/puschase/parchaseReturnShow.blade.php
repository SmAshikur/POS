    ...
    <article>
        ...
        <table class="meta">
            ...
            <tr>
                ...
                <td><span id="prefix" contenteditable>$</span><span>@isset($pur->return_dew) {{$pur->return_dew}}@else 0.00 @endisset BDT</span></td>
            </tr>
        </table>
        ...
        <table class="balance">
            <tr>
                ...
                <td><span data-prefix>$</span><span>{{$pur->return_total}}  BDT</span></td>
            </tr>
            <tr>
                <th><span contenteditable>Amount Paid</span></th>
                <td><span data-prefix>$</span><span contenteditable>{{$pur->return_pay}}  BDT</span></td>
            </tr>
            <tr>
                <th><span contenteditable>Balance Due</span></th>
                <td><span data-prefix>$</span><span>{{$pur->return_dew}}  BDT</span></td>
            </tr>
        </table>
    </article>
    <aside>
