        ...
        <div class="  ">
            <div class="card-header">
                <div class="d-flex justify-content-end">
                    <a href="{{route('return.create')}}"   class="btn btn-success  mr-2"
                       >Add</a>
                </div>
            </div>
                    ...
                    <tbody id=" ">
                        @foreach ($back as $purchas )
                            <tr>
                                ...
                                <th class="btn-group">
                                    <button value="{{$purchas->id}}" id="editBack"
                                        class="m-1 btn btn-success btn-sm editSell custom_model_btn"  >Edit</button>
                                    <a href="{{route('return.show',$purchas->id)}}" target="_blank" id="showPurchas"
                                    ...
                                    <button value="{{$purchas->id}}" id="showPurchas" url="return"
    ...
    <div class="">
        <div class="custom_modal_content card">
            ...
            <div class="card-body">
                ...
                <div id="returnUpdate">
                <form action="" id="returnUpdateForm" method="POST" enctype="multipart/form-data">@csrf @method('PUT')
                        ...
                        @foreach ($back as $purchas )
                            <tr>
                                ...
                                <th class="btn-group">
                                    ...
                                    <div>
                                        <form action="{{url('return/'.$purchas->id)}}" method="post">@csrf @method('DELETE')
                                            <button onsubmit="archiveFunction()" class="m-1 btn btn-danger btn-sm" type="submit"><i class="fas fa-trash"></i></button>
                                        </form>
                                    </div>
                                    <button value="{{$purchas->id}}" id="showPurchas" url="return"
                ...
                <div class="row">
                    <div class=" col-md-6  mt-1  px-4">
                       <div class="form-inline ">
                        <div class="  text-center  mb-1"  style=""> <h4>Seleect Invoice</h4></div>
                        <div class=" ml-3">
                            <select name="" class="form-control ml-2 border-right-0 border returnProduct"
                            id="invoicePurchase" >
                                <option >--select suplier--</option>
                                @foreach ($purchases as $pur )
                                    <option value="{{$pur->id}}">{{$pur->invoice_no}}</option>
                    ...
                    <div class="col-md-6">
                      <div class="form-inline">
                        <span class="mb-1 mr-3"  style=""> <h4>Select Product </h4></span>
                        <select name="invoice product"  class=" form-control ml-2 border-right-0 border testing invoice"
                        id="testing" >
                            <option value="0">---product---</option>
                        </select>
                      </div>
                                ...
                                <div class="" >
                                    ...
                                    <div class="row" id="showCalculate">
                                        <div class="col-7  ">
                                            <div class="row">
                                                <div class="col-6">
                                                    <label class="" for=""> Suplier Name</label>
                                                    <div id="select-two" class="input-group form-group">
                                        ...
                                        <div class="col-5 p-4">
                                            ...
                                            <div class="row text-end mt-1">
                                                ...
                                                id="oldGrandTotal" class="form-control col oldGrandTotal">
                                            </div>
                                            <div class="row text-end mt-1">
                                                <label for="" class="col">Previous Paid</label>
