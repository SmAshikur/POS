            ...
            <tbody id="brandTbody">
                ...
                <tr>
                    ...
                    <th>
                        ...
                        $a =0;
                        @endphp
                        @foreach($brand->dewReturn as $value)
                        @php
                        $a += $value->amount;
                        @endphp
                        @endforeach
                    ...
                    <th class="btn-group">
                        <button href="" value="{{$brand->id}}"  id="dewShow" type="return" class="btn btn-success btn-sm  mb-4" data-toggle="modal" data-target="#modalContactForm">
                            pay</button>
                        <div class="mx-2">
          ...
          <div id="" class="custom_model" >
            <div class="">
                <div class="d-flex justify-content-end">
                    <span class="custom_modal_close" style="margin-top: -20px ; margin-right: 20px ">x</span>
                </div>
                ...
                margin-top:-60px ;  overflow:auto">
                    <div class="card-body ">
                        <div class="p-5 d-flex justify-content-between">
                            <h4> Purchase Return dew of: <label class="ml-5 seller"> </label></h4>
