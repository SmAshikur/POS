            ...
            <tbody id="brandTbody">
                ...
                <tr>
                    ...
                    <th>
                        ...
                        $a =0;
                        @endphp
                        @foreach($brand->dewSell as $value)
                        @php
                        $a += $value->amount;
                        @endphp
                        @endforeach
                    ...
                    <th class="btn-group">
                        <button href="" value="{{$brand->id}}"  id="dewShow" type="sell" class="btn btn-success btn-sm  mb-4" data-toggle="modal" data-target="#modalContactForm">
                            pay</button>
                        <div class="mx-2">
