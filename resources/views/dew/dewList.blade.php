...
<section>
    <div class="d-flex justify-content-end p-2 mb-4 nav-item bg-dark mx-2">
        ...
        <a href="{{route('dew.sell')}}" class="btn nav-link m-1  p-2 {{'dew-sell'== request()->path()?'active':''}}"> Sell Due</a>
        <a href="{{route('dew.return')}}" class="btn nav-link m-1 p-2  {{'dew-return'== request()->path()?'active':''}}"> Purchase Return Due</a>
        <a href="{{route('dew.back')}}" class="btn nav-link m-1  p-2 {{'dew-back'== request()->path()?'active':''}}"> Sell Back Due</a>
    </div>
            ...
            <tbody id="brandTbody">
                ...
                <tr>
                    ...
                    <th>
                        ...
                        $a =0;
                        @endphp
                        @foreach($brand->dewPurchase as $value)
                        @php
                        $a += $value->amount;
                        @endphp
                        @endforeach
                    ...
                    <th class="btn-group">
                        <button href="" value="{{$brand->id}}" type="purchase"  id="dewShow" class="btn btn-success btn-sm  mb-4" data-toggle="modal" data-target="#modalContactForm">
                            pay</button>
                        <div class="mx-2">
                ...
                margin-top:-60px ;  overflow:auto">
                    ...
                    <div class="card-body ">
                        <div class="p-5  d-flex justify-content-between">
                            <h4> Purchase dew of: <label class="ml-5 seller"> </label></h4>
                        ...
                        <div class=" ">
                                <div class="modal-body mx-3">
                                    ...
                                    <div class="col-10 offset-1">
                                        <table id="export_example" class="table text-center table-stripped table-bordered">
                                            <thead>
                                                 <tr>
                                                     <th></th>
                                                     <th>Invoice No </th>
